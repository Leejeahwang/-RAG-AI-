...
def call_ollama_native(prompt, system_prompt="", context="", question=""):
    ...
    system_content = (
        ...
        "반드시 제공된 [참고 매뉴얼]의 대처 수칙과 사실만을 바탕으로 질문에 답변하십시오.\n"
        "매뉴얼 원문의 사실을 요약하거나 왜곡하지 말고 정확하게 그대로 전달하십시오.\n"
        "문장 어미는 음성 출력이 매끄럽도록 공식적인 존댓말(-해야 합니다, -입니다, -하십시오)로 통일하고, 사설 없이 간결하게 수칙 내용만 답변하십시오."
    )
